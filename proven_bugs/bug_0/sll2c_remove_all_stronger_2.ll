; ModuleID = 'bugs/bug_0/sll2c_remove_all_stronger_2.bc'
...
_12:                                              ; preds = %_15, %_3
  ...
  %crab_97 = add i32 %crab_, %_9
  %crab_98 = icmp sle i32 %crab_97, 0
  call void @verifier.assume(i1 %crab_98)
  %crab_99 = add i32 0, %arg1
  %crab_100 = sub i32 %crab_99, %_9
  %crab_101 = icmp eq i32 %crab_100, 0
  call void @verifier.assume(i1 %crab_101)
...
_15:                                              ; preds = %_12
  %crab_102 = sub i32 0, %arg
  %crab_103 = icmp sle i32 %crab_102, -11
  call void @verifier.assume(i1 %crab_103)
  %crab_104 = sub i32 0, %_13
  %crab_105 = icmp eq i32 %crab_104, -2
  call void @verifier.assume(i1 %crab_105)
  %crab_106 = sub i32 0, %arg
  %crab_107 = add i32 %crab_106, %_13
  %crab_108 = icmp sle i32 %crab_107, 0
  call void @verifier.assume(i1 %crab_108)
  %crab_109 = sub i32 0, %arg1
  %crab_110 = add i32 %crab_109, %_9
  %crab_111 = icmp sle i32 %crab_110, 0
  call void @verifier.assume(i1 %crab_111)
  %crab_112 = add i32 0, %arg1
  %crab_113 = sub i32 %crab_112, %_9
  %crab_114 = icmp sle i32 %crab_113, 0
  call void @verifier.assume(i1 %crab_114)
...
_call:                                            ; preds = %_8
  %crab_ = sub i32 0, %_9
  %crab_42 = icmp eq i32 %crab_, 0
  call void @verifier.assume(i1 %crab_42)
  %crab_43 = add i32 0, %_9
  %crab_44 = icmp slt i32 %crab_43, 1
  call void @verifier.assume(i1 %crab_44)
...
_14:                                              ; preds = %_8
  %crab_45 = sub i32 0, %_9
  %crab_46 = icmp sle i32 %crab_45, -2
  call void @verifier.assume(i1 %crab_46)
...
_br4:                                             ; preds = %_14
  %crab_47 = sub i32 0, %_9
  %crab_48 = icmp sle i32 %crab_47, -2
  call void @verifier.assume(i1 %crab_48)
