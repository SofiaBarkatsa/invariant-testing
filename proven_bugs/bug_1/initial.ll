; ModuleID = 'bugs/bug_1/initial.bc'
...
_store2:                                          ; preds = %_7
  %crab_57 = sub i32 0, %_5
  %crab_58 = icmp sle i32 %crab_57, -1
  call void @verifier.assume(i1 %crab_58)
...
_11:                                              ; preds = %_br4, %_store2
  %crab_59 = sub i32 0, %_5
  %crab_60 = icmp sle i32 %crab_59, -1
...
_br4:                                             ; preds = %_11
  %crab_61 = sub i32 0, %_5
  %crab_62 = icmp sle i32 %crab_61, -1
  call void @verifier.assume(i1 %crab_62)
...
_store5:                                          ; preds = %_11
  %crab_63 = sub i32 0, %_5
  %crab_64 = icmp sle i32 %crab_63, -1
  call void @verifier.assume(i1 %crab_64)
  %crab_65 = sub i32 0, %_12
  %crab_66 = icmp sle i32 %crab_65, 0
  call void @verifier.assume(i1 %crab_66)
  %crab_67 = add i32 0, %_12
  %crab_68 = icmp sle i32 %crab_67, 0
  call void @verifier.assume(i1 %crab_68)
...
_br6:                                             ; preds = %_store5, %_7
  %crab_69 = sub i32 0, %_5
  %crab_70 = icmp sle i32 %crab_69, -1
  call void @verifier.assume(i1 %crab_70)
...
_br9:                                             ; preds = %_store7
  %crab_73 = add i32 0, %_5
  %crab_74 = icmp sle i32 %crab_73, 0
  call void @verifier.assume(i1 %crab_74)
  %crab_75 = sub i32 0, %_18
  %crab_76 = icmp sle i32 %crab_75, -1
  call void @verifier.assume(i1 %crab_76)
...
_store5:                                          ; preds = %_11
  ...
  call void @verifier.assume(i1 %crab_64)
  %crab_65 = sub i32 0, %_12
  %crab_66 = icmp sle i32 %crab_65, -1
  call void @verifier.assume(i1 %crab_66)
  %crab_67 = add i32 0, %_12
  %crab_68 = icmp sle i32 %crab_67, 1
  call void @verifier.assume(i1 %crab_68)
  %oracle_27 = sub i32 0, %_5
  %oracle_28 = icmp sle i32 %oracle_27, -1
  call void @__VERIFIER_assert(i1 %oracle_28)
...
_br9:                                             ; preds = %_store7
  ...
  %crab_74 = icmp sle i32 %crab_73, 0
  call void @verifier.assume(i1 %crab_74)
  %crab_75 = add i32 0, %_18
  %crab_76 = icmp sle i32 %crab_75, 0
  call void @verifier.assume(i1 %crab_76)
  %oracle_49 = add i32 0, %_5
  %oracle_50 = icmp sle i32 %oracle_49, 0
  call void @__VERIFIER_assert(i1 %oracle_50)
...
_7:                                               ; preds = %_1
  %crab_ = sub i32 0, %_5
  %crab_8 = icmp sle i32 %crab_, 0
  call void @verifier.assume(i1 %crab_8)
  %crab_9 = add i32 0, %_5
  %crab_10 = icmp sle i32 %crab_9, 0
  call void @verifier.assume(i1 %crab_10)
  %oracle_ = sub i32 0, %_5
